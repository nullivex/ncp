...
/*   */
#define PHP_SAFE_MODE_EXEC_DIR "/opt/ncp/srv/php/bin"
...
/* PHP build date */
#define PHP_BUILD_DATE "2010-11-08"

/* hardcode for each of the cross compiler host */
#define PHP_OS "Linux"

/* hardcode for each of the cross compiler host */
#define PHP_UNAME "Linux dev.nullivex.com 2.6.35.4-rscloud #8 SMP Mon Sep 20 15:54:33 UTC 2010 x86_64 GNU/Linux"
